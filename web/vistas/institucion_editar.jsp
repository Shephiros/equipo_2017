        ...
        <div class="tab-content">
            ...
            <form action="institucionActualizar" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-5">
                    <s:textfield name="institucionSeleccionada.institucionTelefono" cssClass="form-control" cssStyle="width: 30%"></s:textfield>
                    </div>
                    <div class="col-lg-3">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-5">
                    <s:textarea name="institucionSeleccionada.institucionDescripcion" rows="2" cssClass="form-control" cssStyle="width: 100%"></s:textarea>
                    </div>
                    <div class="col-lg-3">
                    </div>
                </div>
