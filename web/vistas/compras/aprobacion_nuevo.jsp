...
<div class="tab-content">
    ...
    <form action="aprobacionGuardar" method="post">
        ...
        <div class="form-row">
            ...
            <div class="col-lg-1">
                <s:textfield name="nuevoAprobado.aprobadoFecha" cssClass="form-control" cssStyle="width: 100%"></s:textfield>
            </div>
            <div class="col-lg-7">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <s:submit value="Guardar" align="left" cssClass="btn btn-default">
